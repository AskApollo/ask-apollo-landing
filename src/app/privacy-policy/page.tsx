        ...
        >
          <div className=" max-w-7xl text-lg mx-auto py-8 sm:py-24 px-4 sm:px-6 lg:px-8 prose prose-a:invert ">
            <div className="flex flex-col text-primary-content">
              ...
              <p>Please read this Privacy Policy (“Privacy Policy”) before using our Service including the Website, Widget and API (as defined below), referred to collectively as the “Service”. This Privacy Policy governs the types of information and data we collect and how we use and share this information. Your access to and use of the Service are available for your use only on the condition that you agree to the Terms of Service available under the following address: <a href="https://www.askapollohq.com/terms">https://www.askapollohq.com/terms</a> (“Terms of Service”) which include the terms of the Privacy Policy set forth below. AskApolloHQ.com (“Company”) operates the Service.We use your data to provide and improve Service. By using Service, you agree to the collection and use of information in accordance with this policy. Unless otherwise defined in this Privacy Policy, the terms used in this Privacy Policy have the same meanings as in our Terms of Service.</p>
              ...
              <p>The controller of your Personal Data is: AskApolloHQ.com.</p>
              ...
              <p>AskApolloHQ.com uses the collected Personal Data for various purposes:</p>
              <ul className=" list-disc list-inside ">
              ...
              <p>If you wish to execute any of the above-mentioned rights, please email us at info@askapollohq.com. Please note that we may ask you to verify your identity before responding to such requests. Please note, we may not able to provide Service without some necessary data.</p>
              ...
              <ul className=" list-disc list-inside ">
                ...
                <li>users are able to change their personal information by emailing us at info@askapollohq.com</li>
              </ul>
              ...
              <p>If you have any questions about this Privacy Policy, please contact us at info@askapollohq.com.</p>
