...
// const bgr1 = Orbitron({ subsets: ["latin"], display: "swap", adjustFontFallback: false, variable: '--font-brigro',weight: "400" });

const Hero = () => {
  return (
    <section className="max-w-7xl mx-auto bg-base-100 flex flex-col lg:flex-row items-center justify-center gap-16 lg:gap-20 px-8 py-20 lg:py-64 ">
      <div className="flex flex-col gap-10 lg:gap-14 items-center justify-center text-center lg:text-left lg:items-start lg:w-full">
        {/* <a
        ...
        <p className="text-lg lg:text-2xl opacity-80 leading-relaxed">
        ...
        <div className=" flex flex-col items-center lg:items-start justify-center space-y-4 ">
          <Link href="#pricing" className=" flex w-fit">
            ...
            <button type="button" className="btn btn-accent hard-shadow btn-wide">Get started now</button>
          </Link>
