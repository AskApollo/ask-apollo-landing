...
const Hero = () => {
  return (
    <section className="max-w-7xl mx-auto bg-base-100 flex flex-col items-center justify-center gap-16 lg:gap-20 px-8 py-20 lg:py-52 lg:pt-32">
      <div className="flex flex-col gap-10 lg:gap-14 items-center justify-center text-center ">
        ...
        <div className=" flex flex-col space-y-4 items-center justify-center text-center lg:w-full">
