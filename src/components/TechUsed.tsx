        ...
        <section className="p-8 md:p-8 flex flex-wrap items-center justify-center gap-4 md:gap-8 bg-base ">
            ...
            <a href="https://vercel.com/" target="_blank" rel="noreferrer" title="Vercel">
                <svg aria-label="Vercel logomark" height="64" role="img" viewBox="0 0 74 64" className=" h-[30px] w-fit opacity-50 hover:opacity-100 transition-opacity duration-300" >
                    <path d="M37.5896 0.25L74.5396 64.25H0.639648L37.5896 0.25Z"  className=" tech-used "></path>
                </svg>
            </a>
